"""
OpenTelemetry configuration for Brain_Net LLM Service
"""
...
def initialize_telemetry() -> None:
    """Initialize OpenTelemetry for the LLM service."""
    if not settings.OTEL_ENABLED:
        logger.info("OpenTelemetry is disabled")
        return
    
    logger.info("Initializing OpenTelemetry for Brain_Net LLM Service...")
...
def get_tracer(name: str = "brain_net_llm"):
    """Get a tracer instance."""
    return trace.get_tracer(name)


def get_meter(name: str = "brain_net_llm"):
